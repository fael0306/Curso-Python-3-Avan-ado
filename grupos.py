fotosagatha = {"Rafael","Rafaela","Sandra","Adriano","Alícia","Diego","Gabriel","Gui","Josi1","Josi2",
                "Júnior","Mãe","Pai","Roland","Lourdes","Lourdes","Tio Rafael"}
...
fammanteigabrde = {"Rafael","Adriano","Diego","Gabriel","Josi2","Júnior","Nilza","Rafaela","Lourdes",
                    "Tio Rafael","João Gabriel","Mãe"}
